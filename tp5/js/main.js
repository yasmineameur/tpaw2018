...
window.onload = function () {
    app = new Vue({
        ...
        // pour ne pas recharger la page à la soumission du formulaire
            ...
            meteo: function (_city) {  
                this.cityWeatherLoading = true;
                    ...
                    fetch('https://demo.bilelz.fr/owmap/?q='+_city.name+'&units=metric&lang=fr&appid=80842cc56b40162ad60794ee6b80d38e')
